...
image bg bedroom = "mod_assets/bedroom.png" # MC's Room BG
image bg sayori_bedroom = "bg/sayori_bedroom.png" # Sayori's Room BG
image bg house = "bg/house.png" # Sayori's House BG
image bg kitchen = "mod_assets/kitchen.png" # MC's Kitchen BG

image bg notebook = "mod_assets/unknown(1) by Melody.chr.png" # Poem Game Notebook Scene
...
#Apple's definition (it's simple because I don't use multiple sprites like dokis, I don't let anyone using it and I worked for it all by myself.)
image apple mad = im.Composite((960, 960), (0, 0), "mod_assets/apple/mad.png")
image apple shocked = im.Composite((960, 960), (0, 0), "mod_assets/apple/shocked.png")
image apple closedeyes = im.Composite((960, 960), (0, 0), "mod_assets/apple/closedeyes.png")
image apple embarrassed = im.Composite((960, 960), (0, 0), "mod_assets/apple/embarrassed.png")
